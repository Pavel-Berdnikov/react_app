...
function App() {
  ...
  React.useEffect(() => {
    async function axiosData() {
      const cartData = await axios.get('https://63600ac33e8f65f283c23b81.mockapi.io/cart');
      const favoritesData = await axios.get('https://63600ac33e8f65f283c23b81.mockapi.io/favorites');
      const productsData = await axios.get('https://63600ac33e8f65f283c23b81.mockapi.io/products');
  ...
  const onRemoveCartItem = (id) => {
    axios.delete(`https://63600ac33e8f65f283c23b81.mockapi.io/cart/${id}`)
